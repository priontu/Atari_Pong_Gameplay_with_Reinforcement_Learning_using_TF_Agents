...
# For consistency across reruns:
np.random.seed(42)
tf.random.set_seed(42)

# Game and environment names:
game_name = "Pong-v4"
environment_name = "PongNoFrameskip-v4"

# Constructing directory for saving images
PROJECT_ROOT_DIR = "."
...
# Creating checkpointer to save all attributes:
...
# Saving the models and policies, and updating checkpoint:
...
# Saving frames and creating GIF:
frames = []
